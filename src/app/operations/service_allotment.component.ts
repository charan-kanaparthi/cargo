...
export class ServiceAllotmentComponent implements OnInit 
{
  isForm=true;
  isShow=false;
  fields:any[]=[];//form fields
  componentName="Service Allotment";//to display on the page
  modalfields:any[]=[];
  ...
  {
     var test={name:'serviceNumber',id:'serviceNumber', value:'',type:'select',label:'Service Number',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:["option1","option2","option3"]};
     ...
     this.fields.push(test);
     test={name:'bookingDate',id:'bookingDate',type:'date range',label:'Booking Date',value:"",isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
     this.fields.push(test);
     ...
     this.fields.push(test);
     test={name:'destinationBranch',id:'destinationBranch', value:'',type:'select',label:'Destination Branch',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:["option1","option2","option3"]};
     this.fields.push(test);
     test={name:'displayAlloted',id:'displayAlloted',type:'checkbox',label:'Display Alloted',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',value:"",options:["displayAlloted"]};
     this.fields.push(test);
     test={name:'iltLR',id:'displayAlloted',type:'checkbox',label:'Include locally transshiped LRs',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',value:"",options:["iltLR"]};
     this.fields.push(test);
