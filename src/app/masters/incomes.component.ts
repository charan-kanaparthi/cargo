...
export class IncomesComponent implements OnInit 
{
  ...
  loadAPI:Promise<any>;
  isForm=true;
  componentName="Incomes";//to display on the page
  tfields=["Id","entryname","priority","status"];//table fields
  private zone: NgZone;
  ...
  public data=[
    {Id:'1',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'},
    {Id:'2',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'},
    {Id:'3',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'},
    {Id:'4',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'},
    {Id:'5',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'},
    {Id:'6',entryname:'Agent Cargo Collection',priority:'Yes',status:'Active',action:'show'}
  ...
  constructor(private router: Router,private mastersService: MastersService,private http:Http,@Inject(Renderer) private renderer: Renderer) 
  {
      ...
      //form fields
      var test={name:'entryname',id:'entryname',  value:'',type:'text',label:'Entry Name',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      ...
      test={name:'priority',id:'priority',type:'radio',value:'',label:'Priority',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:["Yes","No"]};
      this.modalfields.push(test);
      test={name:'status',id:'status',type:'radio',value:'',label:'Status',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:["Active","In-Active"]};
      this.modalfields.push(test);
      ...
      this.theads.push('Id','Entry Name','Priority','Status','Action');
  }
 ...
 //alert(JSON.stringify(this.modalfields));
  ...
  { 
       ...
       for(let field of this.fields)
      {
       ...
       alert(JSON.stringify(form.value));
      this.mastersService.add(form.value,"incomes");
  }
  ...
  {  
       ...
       for(let field of this.modalfields)
      {
       ...
       alert(JSON.stringify(upform.value));
      this.mastersService.update(upform.value,"incomes");
  }
