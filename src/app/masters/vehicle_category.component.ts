...
export class Vehicle_CategoryComponent implements OnInit 
{
  ...
  loadAPI:Promise<any>;
  isForm=true;
  componentName="Vehicle Category";//to display on the page
  tfields=["Id","vehicleManufacturer","vehicleFreight","vehicleType","tonnageCapacity"];//table fields
  private zone: NgZone;
  ...
  public data=[
    {Id:'1',vehicleManufacturer:'Ashok Leyland',vehicleFreight:'0.0',vehicleType:'Non A/c',tonnageCapacity:'13',action:'show'},
    {Id:'2',vehicleManufacturer:'Tata',vehicleFreight:'0.0',vehicleType:'A/c Classy',tonnageCapacity:'17',action:'show'},
    {Id:'3',vehicleManufacturer:'Ashok Leyland',vehicleFreight:'0.0',vehicleType:'Non A/c',tonnageCapacity:'12',action:'show'},
    {Id:'4',vehicleManufacturer:'Ashok Leyland',vehicleFreight:'0.0',vehicleType:'A/c Semi Sleeper',tonnageCapacity:'13',action:'show'},
    {Id:'5',vehicleManufacturer:'Isuzu',vehicleFreight:'0.0',vehicleType:'A/c Classy',tonnageCapacity:'16',action:'show'},
    {Id:'6',vehicleManufacturer:'Isuzu',vehicleFreight:'0.0',vehicleType:'A/c Semi Sleeper',tonnageCapacity:'17',action:'show'}
  ...
  constructor(private router: Router,private mastersService: MastersService,private http:Http,@Inject(Renderer) private renderer: Renderer) 
  {
      ...
      //form fields
      var test={name:'vehicleManufacturer',id:'vehicleManufacturer',  value:'',type:'text',label:'Vehicle Manufacturer',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'vehicleFreight',id:'vehicleFreight',type:'text', value:'', label:'Vehicle Fright',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'vehicleType',id:'vehicleType',type:'text', value:'', label:'Vehicle Type',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'tonnageCapacity',id:'tonnageCapacity',type:'text', value:'', label:'Tonnage Capacity (Ton)',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      ...
      test={name:'vehicleManufacturer',id:'vehicleManufacturer',type:'text',value:'',label:'Vehicle Manufacturer',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'vehicleFreight',id:'vehicleFreight',type:'text',value:'',label:'Vehicle Fright',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'vehicleType',id:'vehicleType',type:'text',value:'',label:'Vehicle Type',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'tonnageCapacity',id:'tonnageCapacity',type:'text',value:'',label:'Tonnage Capacity',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      ...
      this.theads.push('Id','Vehicle Manufacturer','Vehicle Fright','Vehicle Type','Tonnage Capacity','Action');
  }
 ...
 //alert(JSON.stringify(this.modalfields));
  ...
  { 
       ...
       for(let field of this.fields)
      {
       ...
       alert(JSON.stringify(form.value));
      this.mastersService.add(form.value,"vehicleCategories");
  }
  ...
  {  
       ...
       for(let field of this.modalfields)
      {
       ...
       alert(JSON.stringify(upform.value));
      this.mastersService.update(upform.value,"vehicleCategories");
  }
