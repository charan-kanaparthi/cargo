...
export class FreightComponent implements OnInit 
{
  ...
  loadAPI:Promise<any>;
  isForm=true;
  componentName="Freight";//to display on the page
  tfields=["Id","origin","destination","chargePerKg","chargePerCDM","chargePerQuantity"];//table fields
  private zone: NgZone;
  ...
  public data=[
    {Id:'1',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'},
    {Id:'2',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'},
    {Id:'3',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'},
    {Id:'4',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'},
    {Id:'5',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'},
    {Id:'6',origin:'Hyderabad',destination:'Vizaq',chargePerKg:'10',chargePerCDM:'20',chargePerQuantity:'30',action:'show'}
  ...
  constructor(private router: Router,private mastersService: MastersService,private http:Http,@Inject(Renderer) private renderer: Renderer) 
  {
      ...
      //form fields
      var test={name:'origin',id:'origin',  value:'',type:'text',label:'Origin',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      var test={name:'destination',id:'destination',  value:'',type:'text',label:'Destination',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      var test={name:'chargePerKg',id:'charge Per Kg',  value:'',type:'text',label:'Charge Per Kg',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      var test={name:'chargePerCDM',id:'chargePerCDM',  value:'',type:'text',label:'Charge Per CDM',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      var test={name:'chargePerQuantity',id:'chargePerQuantity',  value:'',type:'text',label:'Charge Per Quantity',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
    ...
    //   this.fields.push(test);
      ...
      test={name:'origin',id:'origin',  value:'',type:'text',label:'Origin',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'destination',id:'destination',  value:'',type:'text',label:'Destination',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'chargePerKg',id:'charge Per Kg',  value:'',type:'text',label:'Charge Per Kg',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'chargePerCDM',id:'chargePerCDM',  value:'',type:'text',label:'Charge Per CDM',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      test={name:'chargePerQuantity',id:'chargePerQuantity',  value:'',type:'text',label:'Charge Per Quantity',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test);
      ...
      this.theads.push('Id','Origin','Destination','Charge Per Kg','Charge Per CDM','Charge Per Quantity','Action');
  }
 ...
 //alert(JSON.stringify(this.modalfields));
  ...
  { 
       ...
       for(let field of this.fields)
      {
       ...
       alert(JSON.stringify(form.value));
      this.mastersService.add(form.value,"freight");
  }
  ...
  {  
       ...
       for(let field of this.modalfields)
      {
       ...
       alert(JSON.stringify(upform.value));
      this.mastersService.update(upform.value,"freight");
  }
