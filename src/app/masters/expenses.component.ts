...
export class ExpensesComponent implements OnInit 
{
  ...
  loadAPI:Promise<any>;
  isForm=true;
  componentName="Expenses";//to display on the page
  ...
  public data=[
    {Id:'1',entryname:'Tea',priority:'Yes',status:'Active',action:'show'},
    {Id:'2',entryname:'Papers',priority:'Yes',status:'Active',action:'show'},
    {Id:'3',entryname:'Bata',priority:'Yes',status:'Active',action:'show'},
    {Id:'4',entryname:'Rent',priority:'Yes',status:'Active',action:'show'},
    {Id:'5',entryname:'Tea',priority:'Yes',status:'Active',action:'show'},
    {Id:'6',entryname:'Coffee',priority:'Yes',status:'Active',action:'show'}
 ...
 //alert(JSON.stringify(this.modalfields));
  ...
  { 
       ...
       for(let field of this.fields)
      {
       ...
       alert(JSON.stringify(form.value));
      this.mastersService.add(form.value,"expenses");
  }
  ...
  {  
       ...
       for(let field of this.modalfields)
      {
       ...
       alert(JSON.stringify(upform.value));
      this.mastersService.update(upform.value,"expenses");
  }
