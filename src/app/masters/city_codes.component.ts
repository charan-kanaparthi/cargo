...
export class City_CodesComponent implements OnInit 
{
  ...
  loadAPI:Promise<any>;
  isForm=true;
  componentName="City Codes";//to display on the page
  tfields=["Id","cityName","cityCode","status"];//table fields
  private zone: NgZone;
  ...
  public data=[
    {Id:'1',cityName:'Hyderbad',cityCode:'22',status:'Active',action:'show'},
    {Id:'2',cityName:'Kakinada',cityCode:'107',status:'Active',action:'show'},
    {Id:'3',cityName:'Vizaq',cityCode:'33A',status:'Active',action:'show'},
    {Id:'4',cityName:'Bangalore',cityCode:'22',status:'Active',action:'show'},
    {Id:'5',cityName:'Chennai',cityCode:'107',status:'Active',action:'show'},
    {Id:'6',cityName:'Mumbai',cityCode:'33A',status:'Active',action:'show'}
  ...
  constructor(private router: Router,private mastersService: MastersService,private http:Http,@Inject(Renderer) private renderer: Renderer) 
  {
      ...
      //form fields
      var test={name:'country',id:'country',  value:'',type:'text',label:'Country',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'state',id:'state',type:'text', value:'', label:'State',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'city',id:'city',type:'text', value:'', label:'City',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'cityCode',id:'cityCode',type:'text', value:'', label:'City Code',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      ...
      test={name:'cityName',id:'cityName',type:'text',value:'',label:'City Name',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      ...
      this.theads.push('Id','City Name','City Code','Status','Action');
  }
 ...
 //alert(JSON.stringify(this.modalfields));
  ...
  { 
       ...
       for(let field of this.fields)
      {
       ...
       alert(JSON.stringify(form.value));
      this.mastersService.add(form.value,"cityCodes");
  }
  ...
  {  
       ...
       for(let field of this.modalfields)
      {
       ...
       alert(JSON.stringify(upform.value));
      this.mastersService.update(upform.value,"cityCodes");
  }
