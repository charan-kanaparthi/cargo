...
{
  fields:Field[]=[];
  theads=["Id","Route Name","Service Number","Ts Route","Action"]
   modalfields:Field[]=[];
  ...
  isForm=true;
  tfields=["Id","routeName","serviceNumber","tsRoute"];
  ngOnInit()
  {
     this.loadScript();
  }
   ...
   public data=
 [
    {Id:1,routeName:"Guntur To Vishakapatnam",serviceNumber:"999 Scania",tsRoute:"Guntur To Vishakhapatnam(999-Scania)",action:"show"},
    {Id:2,routeName:"Guntur To Vishakapatnam",serviceNumber:"999 Scania",tsRoute:"Guntur To Vishakhapatnam(999-Scania)",action:"show"} ];
  constructor(private router: Router,private manageService: ManageService,private http:Http,@Inject(Renderer) private renderer: Renderer) 
  {
    //   this.getStatesData();
    //   this.getCitiesData();
      var test={name:'routeName',id:'',type:'text',value:'',label:'Route  Name',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.fields.push(test);
      test={name:'serviceNumber',id:'',type:'text',value:'',label:'Service Number',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:['option1','option2']};
      this.fields.push(test);
      test={name:'origin',id:'',type:'select',value:'',label:'Origin',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:['option1','option2']};
      this.fields.push(test);
      test={name:'destination',id:'',type:'select',value:'',label:'Destination',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:['option1','option2']};
      this.fields.push(test);
      ...
      test={name:'serviceNumber',id:'',type:'text',value:'',label:'Service Number',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:['option1','option2']};
      this.modalfields.push(test);
      test={name:'tsRoute',id:'',type:'text',value:'',label:'TS Route',isRequired:true,isReadOnly:false,isSelected:false,className:'form-control',options:null};
      this.modalfields.push(test); 
